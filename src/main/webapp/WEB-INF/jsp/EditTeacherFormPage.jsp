...
Teacherassessmentform tf = (Teacherassessmentform) session.getAttribute("tf");
CreateformDB cfDB = new CreateformDB();
List<formteacherdetail> Listfd = cfDB.getformteacherdetailById(tf.getTeacherassessmentformid());
%>
		...
		<div class="container">
			<div class="row no-gutter">
				<div class="col-xs-12 col-md-12"
					...
					<h3 style="color: #7EBC1B;">ระบบแก้ไขแบบฟอร์มสหกิจศึกษาสำหรับอาจารย์นิเทศ</h3>
					<div class="nav1" style="color: #FFFFFF;">
						<a href="${pageContext.request.contextPath}/listform"
							...
							href="#" style="color: #E28A06;"> แก้ไขฟอร์ม
						</a>
					</div>
...
<%}else { %>
    ...
    <div class="container" style="width: 70%;">
       ...
       <!--  <h3 style="color: #850000;">แก้ไขแบบฟอร์มสหกิจศึกษาสำหรับพนักงานพี่เลี้ยง</h3>
        ...
        <form action="EditFormTeacher" method="post" onsubmit="return handleFormSubmit()">
	...
	<%-- 	<div style="margin-left: 20px;" >
                   <h4 style="width: 100%;">ชื่อฟอร์ม</h4>
                    <input class="form-control" style="width: 50%" name="title" value="<%=tf.getTitle()%>" required>
                    ...
                    <div class="container-headerform">
					    <div class="left label-group-headerform">
		                    ...
		                    <div style="padding-left: 10px; width: 30%;"><input type="number" min="2566" max="2700" maxlength="4" id="yearE" name="yearE"
											class="form-control data" placeholder="เช่น 2566" value="<%=year%>" readonly="readonly" required></div>
                    ...
                    <div style="padding-left: 30px;"><textarea rows="2" cols="30" class="form-control" style="width: 50%" name="description"><%=tf.getDescription()%></textarea></div>
					 <hr>
                 ...
                 <div style="margin-left: 20%;" >
 					...
 					<div style="display: flex; align-items: center;">
   					 ...
   					 <input class="form-control" style="width: 60%; margin-left: 10px;" name="title" value="<%=tf.getTitle()%>" required>
					</div>
                    ...
                    <div class="container-headerform">
					    ...
					    <br><br><br>
		                    ...
		                    <span style="font-size: 18px;">&nbsp;&nbsp;&nbsp;<%= tf.getDate() %></span><br >
					    </div>
                ...
                <div style="display: flex; align-items: center; width: 100%; margin-left: 20%">
                    ...
                    <div style="padding-left: 10px;"><textarea rows="3" cols="50" class="form-control" style="width: 100%" name="description" ><%=tf.getDescription()%></textarea></div>
					 </div>
                
          <hr>
          <input type="hidden" class="form-control" style="width: 50%" name="tfid" required value="<%=tf.getTeacherassessmentformid()%>">
		</div> 
         	...
         	<h6><b>&nbsp;&nbsp;&nbsp;&nbsp; แบบฟอร์มการประเมินสหกิจศึกษาสำหรับอาจารย์นิเทศคะแนนเต็มคิดเป็นร้อยละ 20 คะแนน</b></h6>
          ...
          <!--   <div class="btn-item" align="center">
            ...
            <br>
            <div align="center">
            <button type="submit" class="btn btn-success" style="margin: 0px 20px 20px 20px; width: 150px;">แก้ไข</button>
            <a href="${pageContext.request.contextPath}/listform"
...
<script>
    document.querySelectorAll('input[type="radio"]').forEach(function(radio) {
        radio.addEventListener('click', function(event) {
            event.preventDefault();  // ป้องกันไม่ให้ผู้ใช้เปลี่ยนค่าของภาคเทอม
        });
    });
</script>
