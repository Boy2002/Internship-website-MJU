...
<script type="text/javascript">
    ...
    function addQuestionNew() {
        ...
        selectType.id = "questionType" + rowCount; // เพิ่มการกำหนด id
        ...
        inputScore.id = "questionScore" + rowCount; // เพิ่มการกำหนด id
        inputScore.name = "questions[" + rowCount + "].score";
        inputScore.placeholder = "กรอกคะแนน";
        inputScore.required = true;
        inputScore.setAttribute("oninput", "updateTotalScore()");
        cell4.appendChild(inputScore);
    ...
    function reindexQuestions() {
        ...
        for (var i = 1; i < rows.length; i++) {
            var questionTextValue = rows[i].cells[1].getElementsByTagName('select').length > 0 
                ? rows[i].cells[1].getElementsByTagName('select')[0].options[rows[i].cells[1].getElementsByTagName('select')[0].selectedIndex].text 
		...
		<div class="container">
			<div class="row no-gutter">
				<div class="col-xs-12 col-md-12"
					...
					<h3 style="color: #7EBC1B;">ระบบสร้างแบบฟอร์มสหกิจศึกษาสำหรับอาจารย์นิเทศสหกิจศึกษา</h3>
...
<%}else { %>
    ...
    <div class="container">
    	<br>
        <h3 style="color: #850000;">สร้างแบบฟอร์มสหกิจศึกษาสำหรับอาจารย์นิเทศสหกิจศึกษา</h3>
		<hr class="style13">
        ...
        <form action="CreateFormTeacher" method="post" onsubmit="return handleFormSubmit()">
            ...
            <input type="hidden" id="totalscorevalue" name="totalscorevalue">
         	...
         	<h6><b>&nbsp;&nbsp;&nbsp;&nbsp; แบบฟอร์มการประเมินสหกิจศึกษาสำหรับอาจารย์นิเทศสหกิจศึกษาคะแนนเต็มคิดเป็นร้อยละ 20 คะแนน</b></h6>
