...
`;
  ...
  //กับปุ่ม addquestion
    ...
    function updateTotalScore() {
        ...
        var table = document.getElementById("questionTable");
        var rows = table.rows;
        console.log("updateTotalScore row ="+rows.length);

        for (var i = 1; i < rows.length; i++) {
        	console.log("updateTotalScore i ="+i);
            var scoreCell = rows[i].cells[3].getElementsByTagName('input')[0];
             try { 
            	var score = parseInt(scoreCell.value);
            	console.log("updateTotalScore score ="+score);
			 } catch (e) {
				var score = 0.0;
			}
...
<%-- 		<div style="margin-left: 20px;" >
                   <h4 style="width: 100%;">ชื่อฟอร์ม</h4>
                    ...
                    <div style="padding-left: 30px;"><textarea rows="2" cols="30" class="form-control" style="width: 50%" name="description"></textarea></div>
					 <hr>
                ...
                <div style="margin-left: 20%;" >
 					...
 					<div style="display: flex; align-items: center;">
   					 ...
   					 <input class="form-control" style="width: 60%; margin-left: 10px;" name="title" value="แบบฟอร์มประเมินการฝึกปฏิบัติสหกิจศึกษานักเศึกษาสาขาเทคโนโลยีสารสนเทศสำหรับพนักงานพี่เลี้ยง" required>
					</div>
