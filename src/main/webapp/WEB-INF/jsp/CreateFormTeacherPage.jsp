		...
		<div class="container">
			<div class="row no-gutter">
				<div class="col-xs-12 col-md-12"
					...
					<h3 style="color: #7EBC1B;">ระบบสร้างแบบฟอร์มสหกิจศึกษาสำหรับอาจารย์นิเทศ</h3>
...
<%}else { %>
    ...
    <div class="container" style="width: 70%;">
    	<br>
        <h3 style="color: #850000;">สร้างแบบฟอร์มสหกิจศึกษาสำหรับอาจารย์นิเทศ</h3>
		<hr class="style13">
		...
		<div style="margin-left: 20%;" >
 					...
 					<div style="display: flex; align-items: center;">
   					 ...
   					 <input class="form-control" style="width: 60%; margin-left: 10px;" name="title" value="แบบฟอร์มประเมินการฝึกปฏิบัติสหกิจศึกษานักเศึกษาสาขาเทคโนโลยีสารสนเทศสำหรับอาจาร์ยนิเทศ" required>
					</div>
                    ...
                    <div class="container-headerform">
					    ...
					    <br><br><br>
		                    ...
		                    <div style="padding-left: 10px; width: 70%;"><input type="number" min="2566" max="2700" maxlength="4" id="yearE" name="yearE"
											class="form-control data" placeholder="เช่น 2566" required></div>
		                    </div>
                ...
                <div style="display: flex; align-items: center; width: 100%; margin-left: 20%">
                    ...
                    <div style="padding-left: 10px;"><textarea rows="3" cols="50" class="form-control" style="width: 100%" name="description"></textarea></div>
					 </div>
		...
		<div style="background-color: white; border-radius: 15px; padding: 50px;  box-shadow: 10px 10px 20px rgba(0, 0, 0, 0.2);" >
            ...
            <a onclick="updateTotalScore()" style="cursor: pointer;"><span id="totalscore" style="font-size: 18px; margin-right: 20px"></span></a>
            </div>
          ...
          <!--   <div class="btn-item" align="center">
            ...
            <br>
            <div align="center">
            <button type="submit" class="btn btn-success" style="margin: 0px 20px 20px 20px; width: 150px;">บันทึก</button>
