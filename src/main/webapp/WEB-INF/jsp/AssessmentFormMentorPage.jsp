    ...
    <div class="container" style="width: 65%;">
     ...
     <!--    <h3 style="color: #850000;">ระบบประเมินผลสหกิจศึกษาสำหรับพนักงานพี่เลี้ยง</h3>
        ...
        <div style="background-color: #F9F9F9; border-radius: 15px; padding: 4%; box-shadow: 10px 10px 20px rgba(0, 0, 0, 0.2); ">
            <form action="AssessmentMentor" method="post" >
                ...
                <!-- <h6><b>&nbsp;&nbsp;&nbsp;&nbsp;คะแนน (1 = น้อยที่สุด	2 = น้อย	3 = ปานกลาง	4 = มาก	5 = มากที่สุด)</b></h6> -->
               ...
               <br>
                <br>
                <div align="center">
                    <button type="submit" class="btn btn-success" style="margin: 20px; width: 150px;">บันทึก</button>
                ...
                if (questionType === "ใช่หรือไม่") {
                    ...
                    questionElement = `
                        <div class="radio-group below-input">
                            <label><input type="radio" name="questions[` + rowCount + `].answer" value="ใช่" data-score="` + questionScore + `" required> ใช่</label>
                            <label><input type="radio" name="questions[` + rowCount + `].answer" value="ไม่ใช่" data-score="0"> ไม่ใช่</label>
                        </div>`;
                } else if (questionType === "กรอกคะแนน") {
                    // แสดง input สำหรับกรอกคะแนน ด้านข้างคำถาม
                    questionElement = `
                        <input type="number" min="1" max="` + questionScore + `" class="form-control question-input inline-input" name="questions[` + rowCount + `].answer" data-score="` + questionScore + `" required>`;
                } else if (questionType === "ข้อความ") {
                    // แสดง textarea ด้านล่างคำถาม
                    questionElement = `
                        <textarea class="form-control full-width below-input" name="questions[` + rowCount + `].answer" rows="3" data-score="` + questionScore + `"></textarea>`;
                }
