...
<%
try{
	mentor = (Mentor)session.getAttribute("Ementor");;
}catch(Exception e) {
	mentor = null;
	}
%>
...
<head>
<meta charset="UTF-8">
<title>แก้ไขข้อมูลส่วนตัว พี่เลี้ยง</title>
...
<%}else{ %>
	<div class="container" style="margin-top: 35px;">
		...
		<form id="frm" method="POST" enctype="multipart/form-data" action="${pageContext.request.contextPath}/EditMentorNew" >
<br><br>
    ...
    readURL(this);
							...
							<div class="form-group row" style="padding-top: 3%;">
									<div class="col-sm-12 text-center">
										...
										<a href = "#" onclick="window.history.back();" class="btn btn-warning" >ยกเลิก </a>
									</div>
								</div>
						</div>
					</div>
