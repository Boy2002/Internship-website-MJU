...
/*         selectType2.onchange = function() {
     ...
     // สร้าง select สำหรับลิสต์คำถาม
        ...
        cell6.innerHTML = `
      	    <button type="button" class="btn btn-secondary btnposition" onclick="moveUp(this)"><i class="fa-solid fa-arrow-up"></i></button>
      	    <button type="button" class="btn btn-secondary btnposition" onclick="moveDown(this)"><i class="fa-solid fa-arrow-down"></i></button>
      	`;
		...
		<div class="container">
			<div class="row no-gutter">
				<div class="col-xs-12 col-md-12"
					...
					<h3 style="color: #7EBC1B;">ระบบแก้ไขแบบฟอร์มสหกิจศึกษาสำหรับพนักงานพี่เลี้ยง</h3>
...
<%}else { %>
    ...
    <div class="container" style="width: 70%;">
       ...
       <!--  <h3 style="color: #850000;">แก้ไขแบบฟอร์มสหกิจศึกษาสำหรับพนักงานพี่เลี้ยง</h3>
        ...
        <form action="EditFormMentor" method="post" onsubmit="return handleFormSubmit()">
                    ...
                    <div class="container-headerform">
					    ...
					    <br><br><br>
		                    ...
		                    <div style="padding-left: 10px; width: 70%;"><input type="number" min="2566" max="2700" maxlength="4" id="yearE" name="yearE"
											class="form-control data" placeholder="เช่น 2566" value="<%=year%>" required readonly="readonly"></div>
		                    </div>
