			...
			<div class="container" style="margin-top: -20px">
				<div class="row">
					<div class="col-lg-12">
					 ...
					 <form name="frm" method="get" action="${pageContext.request.contextPath}/searchCompanyStuTeacher" >
					...
					<table class="table table-bordered" id="myTable" style="width:70%">
								<thead class="table-info">
									<tr align="center">
										<th style="width: 10%;" > รหัสบริษัท </th>
										<th style="width: 55%;"> ชื่อบริษัท</th>
										<th style="width: 15%;" > จำนวนนักศึกษา </th>
										<th style="width: 20%;"> ทำแบบประเมินนักศึกษา </th>
				                ...
				                <td align="center"><%=sumstu%></td>			           			                
				                 <td align="center"><a href="${pageContext.request.contextPath}/loadlistStuTeacherPage?getCompanyid=<%=C.getCompanyid()%>&getSemester=<%=Semester%>" ><button class="btn btn-success" ><i class="fa fa-address-book-o" style="font-size:17px"></i></button></a></td>
		                 		</tr>
