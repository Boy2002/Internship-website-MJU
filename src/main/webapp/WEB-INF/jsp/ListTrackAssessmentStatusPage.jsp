...
<%
    ...
    TrackAssessmentDB taDB = new TrackAssessmentDB(); 
%>
...
<meta charset="UTF-8">
<title>Track Assessment Status</title>
...
<h3 style="color:#7EBC1B;" >ระบบตรวจสอบสถานะการประเมินผลสหกิจศึกษา </h3>
...
<%}else{ %>
	...
	<div class="container" style="margin-top: 35px;">
		...
		<section id="content">
			<div class="container" style="margin-top: -20px">
				<div class="row">
					<div class="col-lg-12">
					 <form name="frm" method="post" action="${pageContext.request.contextPath}/loadnameTrack" >
						<div class="container">
							<h3 style="color:#850000;" >ตรวจสอบสถานะการประเมินผลสหกิจศึกษา </h3>
							<hr class="style13">
	...
	<div class="container" style="margin-top: 35px;">
               <%--  <div align = "right">
				<a href = "${pageContext.request.contextPath}/ExportStudentPage" class="btn btn-primary" ><i class="fa-solid fa-file-export"></i> Export Excel File  </a>
				</div> --%>
				<h6>จำนวนนักศึกษา <%=student.size() %> คน </h6>
   <table class="table table-bordered" id="myTable">
                    <thead class="table-info">
                    <tr align = "center">
                     <th colspan="5"> <%=getSemester%> </th>
                     <th colspan="2">สถานะการประเมิน</th>
                    </tr>
                        <tr align = "center">
                            <th>รหัสนักศึกษา</th>
                            <th>ชื่อนักศึกษา</th>  
                            ...
                            <th>ระยะเวลาการฝึกสหกิจศึกษา</th> 
                             <th>อาจารย์นิเทศ</th> 
                            <th style="background-color: #9A7E6F; color: white;">อาจารย์</th> 
                            <th style="background-color: #3A6D8C; color: white;">พี่เลี้ยง</th>
                   ...
                   <%for(Student S : student){ %>
                 	<%
                 	AssisgnTeacherDB atDB = new AssisgnTeacherDB();
                 	teacherManager tm = new teacherManager();
                 	teacher t = new teacher();
					List<mentoranswer> mentorAnswers = taDB.ListmentoranswerByStuid(S.getIdstudent());
					List<teacheranswer> teacherAnswers = taDB.ListteacheranswerByStuid(S.getIdstudent());
					
					Assignsupervision CheckCompany = atDB.CheckCompany(S.getCompany_companyid(),getSemester);
									
					boolean Mtrack = mentorAnswers.isEmpty();
					boolean Ttrack = teacherAnswers.isEmpty();
					//System.out.println("id boolean " + S.getIdstudent() + " " + Mtrack);
					String MstatusClass = Mtrack ? "status-not-assessment" : "status-assessment";
					String MstatusText = Mtrack ? "fa-solid fa-xmark" : "fa-solid fa-check";
					String TstatusClass = Ttrack ? "status-not-assessment" : "status-assessment";
					String TstatusText = Ttrack ? "fa-solid fa-xmark" : "fa-solid fa-check";
					%>
                 ...
                 <tr align = "center">
				  ...
				  <th> <%=com.getCompanyname()%></th>
								...
								<%	if (CheckCompany != null){
									t = tm.Searchteacherid(Integer.parseInt(CheckCompany.getTeacherid()));
								%>		
								<th><%=t.getTeachername()+" "+t.getTeacherlastname() %></th>
								<%}else{ %>		
								<th>ไม่พบอาจารย์นิเทศ</th>
								<%} %>				
                                <th> <div class="<%= TstatusClass %>" ><i class="<%= TstatusText %>"></i></div></th>
                                <th> <div class="<%= MstatusClass %>" ><i class="<%= MstatusText %>"></i></div></th>
